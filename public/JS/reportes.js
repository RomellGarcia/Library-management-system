...
// ====================== UTILIDADES ======================
// Modelo: x(t) = C · e^(k · t)
// C y k se calculan en el backend con punto promedio sobre los 6 meses.
...
function calcularProyeccion() {
  ...
  var advertencia = mesesConDatos < 6
    ? '<div style="background:#FFF8E1;border-left:4px solid #BC955B;padding:10px 14px;margin-bottom:12px;border-radius:4px;font-size:0.88rem">' +
      '⚠️ Predicción basada en <strong>' + mesesConDatos + ' de 6 meses</strong> con préstamos reales. ' +
  ...
  // Tabla del modelo — siempre punto promedio, misma estructura
  if (document.getElementById('tablaModelo')) {
    // Tabla de datos con los 6 meses (mostrando el ajuste 0→0.1)
