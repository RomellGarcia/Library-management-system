...
function calcularProyeccion() {
    ...
    // ── Proyecciones: periodos meses ADELANTE desde el último mes real ──
    // periodos=1 → 1 mes futuro (May), periodos=13 → 13 meses futuros (May..May27)
    var proyecciones = [];
    var proyGrafica = [];
    var mesesFuturos = [];
    var nFuturos = periodos;   // ← CORRECCIÓN: siempre = periodos, sin Math.max
    ...
    for (var i = 1; i <= nFuturos; i++) {
        var tAbs = tFinal + i;                        // t=6,7,8... siempre DESPUÉS de Abr
